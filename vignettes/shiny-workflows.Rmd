...
switch between labels and info boxes, add connector lines, preview a static
render, and download the current artifacts.
...
- `label_table()` — `make_region_labels()` output with style flags
