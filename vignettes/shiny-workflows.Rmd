...
line pattern, smart connectors, arrow endpoints, legend title, and map
background; preview a static render; set static export size and DPI; and
download the current artifacts.
