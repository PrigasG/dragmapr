...
enter a URL, or reopen a saved project ZIP; pick grouping and label columns;
...
- **Bundle ZIP** — all of the above plus `palette.csv` and `metadata.json`;
  enough to reopen the project in Spatial Studio, reconstruct the layout in a
  new session, or hand off to a collaborator
